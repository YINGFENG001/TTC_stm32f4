...
static void ShowCommandHelp(void)
{
  ...
  printf("\n  clamp open");
  printf("\n  clamp close");
  printf("\n  clamp move [openPos/Pct: 700~2048 or measured 0.0%%~100.0%%]");
  printf("\n  clamp grip [load: 100~750(0.1%%)] [openPos/Pct: 700~2048 or measured 0.0%%~100.0%%, optional]");
  printf("\n  clamp release");
...
void ShowHelp(void)
{
  ...
  printf("\n        move     = openPos/Pct, e.g. 700, measured 100%% or 66.0%%");
