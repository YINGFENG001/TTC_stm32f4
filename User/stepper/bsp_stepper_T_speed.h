...
typedef struct {
  ...
  unsigned int target_min_delay;
  unsigned int target_speed;
  unsigned int target_accel;
  unsigned int target_decel;
  signed int current_speed_q16;
  signed int target_speed_q16;
} speedRampData;
...
#define DECEL             2 // 减速状态
#define RUN               3 // 匀速状态
#define SPEED_ACCEL       4 // 连续运行动态升速状态
#define SPEED_DECEL       5 // 连续运行动态降速状态
